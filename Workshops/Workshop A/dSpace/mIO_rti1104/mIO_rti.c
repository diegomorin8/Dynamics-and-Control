...
#define RTB_STRUCTURE_NAME             mIO_B
#define RTP_STRUCTURE_NAME             mIO_P
...
{
  /* Calls for base sample time: [0.025, 0] */
  /* dSPACE I/O Board DS1104 #1 Unit:ENC_POS Group:POS */
  mIO_B.SFunction1 = (real_T) ds1104_inc_position_read(1,
    DS1104_INC_LINE_SUBDIV_4);

  /* dSPACE I/O Board DS1104 #1 Unit:ENC_POS Group:DPOS */
  mIO_B.SFunction2 = (real_T) ds1104_inc_delta_position_read(1,
    DS1104_INC_LINE_SUBDIV_4);
}
