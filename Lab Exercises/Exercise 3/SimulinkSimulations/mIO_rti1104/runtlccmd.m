function runtlccmd
% RUNTLCCMD - run tlc command (regenerate C code from .rtw file) for model mIO
% This function will run the tlc command stored in the variable 
% "tlccmd" in tlccmd.mat, whose contents is as follows:
% 
% 	tlc
% 	-r
% 	C:\Users\es2lab2\Documents\MATLAB\Dynamics-and-Control\Lab Exercises\Exercise 3\SimulinkSimulations\mIO_rti1104\mIO.rtw
% 	C:\Program Files (x86)\dSPACE RCPHIL 2014-B\MATLAB\RTI\RTI1104\TLC\rti1104.tlc
% 	-OC:\Users\es2lab2\Documents\MATLAB\Dynamics-and-Control\Lab Exercises\Exercise 3\SimulinkSimulations\mIO_rti1104
...
% 	-IC:\Users\es2lab2\Documents\MATLAB\Dynamics-and-Control\Lab Exercises\Exercise 3\SimulinkSimulations\mIO_rti1104\tlc
...
% 	-p10000
   ...
   if ~sysopen
      ...
      rtwprivate('rtwattic', 'setBuildDir', 'C:\Users\es2lab2\Documents\MATLAB\Dynamics-and-Control\Lab Exercises\Exercise 3\SimulinkSimulations\mIO_rti1104');
      ...
      set_param('mIO', 'RTWGenSharedUtilitiesWithoutAssert', -1);
      cd(savedpwd);
