...
#
#  $RCSfile: mIO.mk $ $Revision: 2.71 $ $Date: 2014/07/09 11:55:48MESZ $
#  $ProjectName: e:/ARC/Products/ImplSW/RTISW/RTI/Components/Build/Makefile/project.pj $
# =============================================================================
# NEVER CHANGE THIS LINE:
# RTI_TEMPLATE_MAKEFILE_VERSION = 230
# =============================================================================
...
MATLAB_BIN                     = C:\Program Files (x86)\MATLAB\R2014b\bin
MATLAB_ROOT_ALT                = C:\PROGRA~2\MATLAB\R2014b
MATLAB_BIN_ALT                 = C:\PROGRA~2\MATLAB\R2014b\bin
RELEASE_VERSION                = R2014b
RELEASE_VERSION               := $(RELEASE_VERSION,S'\.'_',W_,LC,S'^r'')
COMPUTER                       = PCWIN
MODEL                          = mIO
MODULES                        = mIO_data.c mIO_trc_ptr.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c 
S_FUNCTIONS                    = 
S_FUNCTIONS_LIB                = 
SOLVER                         = 
NUMST                          = 2
...
RTWCUST_INCLUDES = \
	"$(START_DIR)\mIO_rti1104" \
	"$(START_DIR)" \
	"C:\Users\es2lab2\DOCUME~1\MATLAB\DYNAMI~1\WORKSH~1\WORKSH~1\dSpace"
...
download :
	...
	%if ('$(LOAD_OPT)' == 'ON') || ('$(LOAD_OPT)' == 'FLASH')
	  ...
	  --$(CMDLOADER) -ol 2 $(FLASH_OPT) $(PLATFORM_OPT) $(SDFFILE) $(SLAVE_OPT)
	  %if $(status)
