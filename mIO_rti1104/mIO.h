...
typedef struct {
  ...
  real_T FF_PID_states;                /* '<Root>/FF_PID' */
...
struct P_mIO_T_ {
  ...
  real_T Pos_YFinal;                   /* Expression: 1
                                        * Referenced by: '<Root>/Pos'
                                        */
  real_T FF_PID_NumCoef[2];            /* Expression: FF_num{1,1}
                                        * Referenced by: '<Root>/FF_PID'
                                        */
  real_T FF_PID_DenCoef[2];            /* Expression: FF_den{1,1}
                                        * Referenced by: '<Root>/FF_PID'
                                        */
  real_T FF_PID_InitialStates;         /* Expression: 0
                                        * Referenced by: '<Root>/FF_PID'
                                        */
