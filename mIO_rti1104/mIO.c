...
void mIO_output(void)
{
  ...
  if (rtmIsMajorTimeStep(mIO_M)) {
    ...
    mIO_B.ProportionalGain1_c = mIO_P.ProportionalGain1_Gain_c *
      mIO_B.fi1_scaling;
...
RT_MODEL_mIO_T *mIO(void)
{
  ...
  mIO_M->Sizes.numBlockIO = (76);      /* Number of block outputs */
  mIO_M->Sizes.numBlockPrms = (76);    /* Sum of parameter "widths" */
  return mIO_M;
}
